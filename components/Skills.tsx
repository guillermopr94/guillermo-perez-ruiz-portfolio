...
const Skills: React.FC = () => {
  ...
  return (
    <section id="skills" className="py-20 bg-slate-900/50 relative overflow-hidden scroll-mt-20">
      {/* Background Decor */}
          ...
          {SKILLS_DATA.map((category) => (
            ...
            >
              <div className="flex items-center gap-3 mb-6">
                <div className="p-3 bg-slate-900 rounded-lg group-hover:bg-secondary/20 transition-colors">
